...
public class Settings : MonoBehaviour {
    ...
    const string SOUNDS_KEY = "sounds_cubele";
    const string VIBRATIONS_KEY = "vibrations_cubele";
    const string TOP_SCORE_KEY = "top_score_cubele";
    const string LAST_SCORE_KEY = "last_score_cubele";
