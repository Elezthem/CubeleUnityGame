...
public class SoundsManager_cubele : MonoBehaviour {
    ...
    static SoundsManager_cubele instance;

	public SoundsManager_cubele Instance {
        get {
            if (instance == null) {
                DontDestroyOnLoad(gameObject);

                instance = GetComponent<SoundsManager_cubele>();
            }
